 ...
 */
class RecurringQuoteFromOrderConverter
{
    /**
     ...
     *
     * @param \Qliro\QliroOne\Api\Data\AdminOrderInterface $container
    ...
    public function convert($container, Quote $quote)
    {
        ...
        $this->orderItemsConverter->convert($container->getOrderItemActions(), $quote);
